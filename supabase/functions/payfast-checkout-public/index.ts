...
Deno.serve(async (req) => {
  ...
  // Optional override for the PayFast process URL. Lets ops swap the
  // form-POST target without a redeploy (e.g. point to a maintenance
  // host or PayFast's documented alternate endpoint).
