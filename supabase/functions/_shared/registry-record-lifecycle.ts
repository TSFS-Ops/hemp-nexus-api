/**
 * Batch 10 — Import-to-Claim Lifecycle SSOT (Deno mirror).
 * Pinned to src/lib/registry-record-lifecycle.ts by
...
/**
 * Pure claim-availability engine.
 * Inputs are denormalised facts. Output includes both safe public reason
 * and internal reason for admin surfaces.
 */
