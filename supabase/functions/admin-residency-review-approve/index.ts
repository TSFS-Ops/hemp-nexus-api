...
Deno.serve(async (req) => {
  ...
  try {
    await recordAdminHqDecision({
      admin, sourceFunction: "admin-residency-review-approve",
      actionCode: "residency_review.approve",
    ...
    console.error("[admin-residency-review-approve] CRITICAL: gov audit failed:", govErr);
