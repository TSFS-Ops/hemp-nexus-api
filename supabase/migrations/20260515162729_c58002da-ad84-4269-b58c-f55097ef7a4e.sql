-- Batch O Phase 2 fix: matches table has no completed_at/updated_at columns.
-- Drop and recreate without them. Order rows by created_at instead.

DROP FUNCTION IF EXISTS public.admin_list_inconsistent_matches();
