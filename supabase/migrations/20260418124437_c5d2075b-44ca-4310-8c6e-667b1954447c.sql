...
BEGIN
  ...
  -- Determine real counterparty (the other side of the trade).
  ...
  -- Only write to the bilateral collapse_ledger when a distinct
  -- counterparty exists. Unilateral signals (no counterparty, or self)
  -- skip the ledger entry; the match_event above is sufficient evidence.
