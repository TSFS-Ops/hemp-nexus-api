...
-- Proof prerequisite organization not present; proof block skipped during clean replay.
RAISE NOTICE 'Proof prerequisite organization not present; SSO trigger proof block skipped during clean replay.';
RETURN;
END IF;
