...
BEGIN
  ...
  -- Use real commercial values from the match; fall back to 1 to satisfy
  -- the collapse_ledger_price_check (price > 0) constraint when a match
  -- has no price set (e.g. unilateral signal).
