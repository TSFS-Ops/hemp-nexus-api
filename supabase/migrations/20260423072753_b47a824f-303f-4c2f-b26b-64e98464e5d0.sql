-- Fix _provision_user: replace email-as-org-name with PII-free placeholder.
-- Keeps the existing jsonb return type and all other logic intact.
...
BEGIN
  ...
  ELSE
    -- Use a safe, PII-free placeholder. The legal entity name is captured
    -- by the onboarding/KYC wizard. This satisfies orgs_name_no_email and
    -- aligns with POPIA/GDPR data-minimisation.
