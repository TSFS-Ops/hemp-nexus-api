DROP POLICY IF EXISTS "export_buckets_restrict_authenticated_select" ON storage.objects;
DROP POLICY IF EXISTS "export_buckets_restrict_authenticated_insert" ON storage.objects;
DROP POLICY IF EXISTS "export_buckets_restrict_authenticated_update" ON storage.objects;
DROP POLICY IF EXISTS "export_buckets_restrict_authenticated_delete" ON storage.objects;
