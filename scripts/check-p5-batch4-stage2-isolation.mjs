...
const STAGE3_EXEMPT_BASENAMES = new Set(["rpc.ts", "summary-client.ts", "org-user-client.ts", "funder-client.ts"]);
...
// Stage 6 adds src/pages/funder/p5-batch4 (funder surface).
// Registry surface remains forbidden.
