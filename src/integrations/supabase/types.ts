  ...
  public: {
    Tables: {
      ...
      registry_api_approval_events: {
        ...
        Relationships: [
          {
            foreignKeyName: "registry_api_approval_events_client_id_fkey"
            columns: ["client_id"]
            isOneToOne: false
      ...
      registry_api_blocked_events: {
        ...
        Relationships: [
          {
            foreignKeyName: "registry_api_blocked_events_client_id_fkey"
            columns: ["client_id"]
            isOneToOne: false
            referencedRelation: "registry_api_clients"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "registry_api_blocked_events_key_id_fkey"
            columns: ["key_id"]
            isOneToOne: false
            referencedRelation: "registry_api_keys"
            referencedColumns: ["id"]
      ...
      registry_api_client_countries: {
        ...
        Relationships: [
          {
            foreignKeyName: "registry_api_client_countries_client_id_fkey"
            columns: ["client_id"]
            isOneToOne: false
            referencedRelation: "registry_api_clients"
            referencedColumns: ["id"]
      ...
      registry_api_client_scopes: {
        ...
        Relationships: [
          {
            foreignKeyName: "registry_api_client_scopes_client_id_fkey"
            columns: ["client_id"]
            isOneToOne: false
            referencedRelation: "registry_api_clients"
            referencedColumns: ["id"]
      ...
      registry_api_client_use_cases: {
        ...
        Relationships: [
          {
            foreignKeyName: "registry_api_client_use_cases_client_id_fkey"
            columns: ["client_id"]
            isOneToOne: false
            referencedRelation: "registry_api_clients"
            referencedColumns: ["id"]
      ...
      registry_api_clients: {
        Row: {
          ...
          production_acknowledged_by: string | null
      ...
      registry_api_rate_limit_profiles: {
        Row: {
          created_at: string
          created_by: string | null
          description: string | null
      ...
      registry_api_test_console_events: {
        Row: {
          actor_id: string | null
          audit_reference: string | null
          client_id: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "registry_api_test_console_events_client_id_fkey"
            columns: ["client_id"]
            isOneToOne: false
            referencedRelation: "registry_api_clients"
            referencedColumns: ["id"]
      ...
      registry_api_usage_events: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "registry_api_usage_events_key_id_fkey"
            columns: ["key_id"]
            isOneToOne: false
            referencedRelation: "registry_api_keys"
            referencedColumns: ["id"]
      ...
      registry_company_claim_assignments: {
        Row: {
          active: boolean
        ...
        Relationships: [
          {
            foreignKeyName: "registry_company_claim_assignments_claim_id_fkey"
            columns: ["claim_id"]
            isOneToOne: false
            referencedRelation: "registry_company_claims"
            referencedColumns: ["id"]
      ...
      registry_company_claim_evidence: {
        Row: {
          category: string | null
          claim_id: string
          claimant_statement: string | null
          created_at: string
          description: string
      ...
      registry_company_claim_notes: {
        ...
        Relationships: [
          {
            foreignKeyName: "registry_company_claim_notes_claim_id_fkey"
            columns: ["claim_id"]
            isOneToOne: false
            referencedRelation: "registry_company_claims"
            referencedColumns: ["id"]
      ...
      registry_company_claim_review_events: {
        Row: {
          action: string
          claim_id: string
          created_at: string
        ...
        Relationships: [
          {
            foreignKeyName: "registry_company_claim_review_events_claim_id_fkey"
            columns: ["claim_id"]
            isOneToOne: false
            referencedRelation: "registry_company_claims"
            referencedColumns: ["id"]
      ...
      registry_company_claim_status_notifications: {
        Row: {
          audit_event_name: string
          body: string | null
          channel: string
        ...
        Relationships: [
          {
            foreignKeyName: "registry_company_claim_status_notifications_claim_id_fkey"
            columns: ["claim_id"]
            isOneToOne: false
            referencedRelation: "registry_company_claims"
            referencedColumns: ["id"]
      ...
      support_category_routing: {
        ...
        Relationships: [
          {
            foreignKeyName: "support_category_routing_category_key_fkey"
          ...
          {
            foreignKeyName: "support_category_routing_subcategory_key_fkey"
          ...
          {
            foreignKeyName: "support_category_routing_team_key_fkey"
            columns: ["team_key"]
            isOneToOne: false
      ...
      support_incident_updates: {
        ...
        Relationships: [
          {
            foreignKeyName: "support_incident_updates_incident_id_fkey"
            columns: ["incident_id"]
            isOneToOne: false
      ...
      support_knowledge_articles: {
        ...
        Relationships: [
          {
            foreignKeyName: "support_knowledge_articles_category_key_fkey"
            columns: ["category_key"]
            isOneToOne: false
            referencedRelation: "support_categories"
            referencedColumns: ["key"]
      ...
      support_team_members: {
        Row: {
          ...
          id: string
          is_active: boolean
          member_role: Database["public"]["Enums"]["support_team_member_role"]
          team_key: string
          user_id: string
        }
        Insert: {
        ...
        Relationships: [
          {
            foreignKeyName: "support_team_members_team_key_fkey"
            columns: ["team_key"]
            isOneToOne: false
            referencedRelation: "support_teams"
            referencedColumns: ["key"]
      ...
      support_ticket_assignments: {
        ...
        Relationships: [
          {
            foreignKeyName: "support_ticket_assignments_team_key_fkey"
            columns: ["team_key"]
            isOneToOne: false
            referencedRelation: "support_teams"
            referencedColumns: ["key"]
      ...
      support_tickets: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "support_tickets_current_team_key_fkey"
            columns: ["current_team_key"]
            isOneToOne: false
            referencedRelation: "support_teams"
            referencedColumns: ["key"]
          },
    ...
    Functions: {
      ...
      registry_api_scope_is_forbidden: {
        Args: { _scope: string }
        Returns: boolean
      }
    ...
    Enums: {
      ...
      support_event_kind:
        ...
        | "internal_note_added"
        | "linked_record_added"
      support_incident_severity: "minor" | "major" | "critical" | "maintenance"
      ...
      support_restriction_class:
        ...
        | "funder_evidence"
        | "payment_dispute"
      support_team_member_role: "lead" | "member"
