...
function TerminalMockup() {
  return (
    ...
    >
      ...
      <div
        aria-hidden
        className="absolute -inset-8 -z-10 rounded-[32px] blur-3xl opacity-70"
        style={{
          background:
            "radial-gradient(ellipse at 50% 60%, rgba(16,185,129,0.28) 0%, rgba(16,185,129,0.08) 40%, transparent 70%)",
        }}
      />
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-12 pt-24 pb-32 lg:pt-36 lg:pb-48">
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div>
              ...
              >
                Integrate the Izenzo API to embed cryptographic trade
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 py-32 lg:py-44">
          <div className="max-w-2xl mb-20 lg:mb-28">
            ...
            <p className="mt-6 text-lg text-slate-600 leading-relaxed">
              Four primitives — guides, reference, SDKs, and live status —
              composed into a single, hard-engineering surface.
            </p>
          </div>
            ...
            {HUB_CARDS.map((card, i) => {
              ...
              return (
                ...
                >
                  <Link
                    to={card.href}
                    className="group flex flex-col h-full rounded-2xl bg-white border border-slate-100 p-8 hover:border-emerald-200 hover:shadow-md transition-all"
                  >
                    <div className="flex items-start justify-between mb-6">
                      ...
                      {card.statusBadge && (
                        <span className="inline-flex items-center gap-1.5 px-2 py-1 rounded-full bg-emerald-50 ring-1 ring-emerald-200">
      ...
      <section className="relative bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-12 py-32 lg:py-44 text-center">
          ...
          <p className="mt-8 text-lg text-slate-600 max-w-xl mx-auto leading-relaxed">
            ...
            cryptographically sealed deal today.
          </p>
          <div className="mt-12 flex flex-wrap items-center justify-center gap-4">
            ...
            <Link
              to={ROUTES.DOCS}
              className="inline-flex items-center gap-2 rounded-md px-7 py-4 text-sm font-medium text-slate-900 hover:bg-slate-50 transition-colors"
            >
              Read the docs
              <ArrowRight className="h-4 w-4 opacity-60" strokeWidth={2} />
            </Link>
