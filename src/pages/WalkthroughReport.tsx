...
const verificationChecklist = [
  ...
  "POI completion probability is ≥ 50.1%",
  "Collapse ledger entry created and immutable",
  "WaD sealed with attestations",
  "Evidence Pack export generated",
  "Audit trail export contains lifecycle events end-to-end",
];
      ...
      <main className="mx-auto w-full max-w-5xl px-4 py-8 sm:px-6 print:max-w-none print:px-0 print:py-0">
        <div className="mb-6 flex flex-wrap items-center justify-between gap-3 rounded-lg border bg-muted/30 p-4 print:hidden">
          <p className="text-sm text-muted-foreground">
            Use <strong>Download PDF</strong>, then choose <strong>Save as PDF</strong> in your browser print dialog.
          </p>
        ...
        <section className="space-y-4">
          {phases.map((phase, phaseIndex) => (
            <Card key={phase.title} className="break-inside-avoid print:shadow-none">
              <CardHeader>
