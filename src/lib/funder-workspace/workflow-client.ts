 ...
 * Working-review client library: RFIs, notes / shared comments, and
 * formal decisions.
 *
 * All mutations route through Batch 5 fw_* / fw_admin_* / fw_funder_* RPCs.
 * Every RPC is SECURITY DEFINER and enforces:
 ...
 *
 * Reads use RLS-scoped selects on the Batch 5 tables. The DB returns
 * only rows the caller may see (admin OR caller's funder org).
 */
...
// ─── Approved Batch 5 RPC names (guard-tested) ───────────────
