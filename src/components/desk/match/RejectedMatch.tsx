        ...
        <div className="px-16 pt-12 pb-24 max-w-2xl">
          ...
          <div className="mt-10">
            ...
            <div className="rounded-sm border border-slate-200 bg-slate-50 px-5 py-4 space-y-2">
              ...
              <p className="font-mono text-[11px] text-slate-700">
                <span className="text-slate-500">[2026-04-16 21:05]</span> · Gates 1–4a passed.
              </p>
          ...
          <div className="mt-20 pt-12 border-t border-slate-200">
            ...
            <div className="space-y-3">
              ...
              <button
                onClick={() => navigate("/desk")}
                className="w-full inline-flex items-center justify-center gap-2 rounded-md px-6 py-4 text-sm font-medium text-slate-600 hover:text-red-700 hover:bg-red-50 transition-colors border border-transparent hover:border-red-100"
              >
